...
class CheckoutController extends Controller
{
    ...
    public function addcheckout_information(Request $request)
    {
        ...
        Session::put('checkoutinfo',$add);

        // $add->save();

        // if ($add) {
        //     return redirect()->route('web_checkout')->with('success', 'value');
        // } else {
