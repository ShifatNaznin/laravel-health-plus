                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <form method="post" action="{{route('about_insert')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <textarea name="sub_heading" value="{{old('sub_heading')}}" id="" cols="100" rows="10">{{old('sub_heading')}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
