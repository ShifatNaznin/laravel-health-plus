            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h4>Accessories Category Image List</h4>
                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <a href="{{route('accessories_image_add')}}" class="btn btn-warning">Add</a>
                    </div>
                </div>
            </div>
        </div>
