            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        {{-- <a href="{{route('addbanner_add')}}" class="btn btn-warning">Add</a> --}}
                    </div>
                </div>
            </div>
        </div>
