            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <a href="{{route('blog_add')}}" class="btn btn-warning">Add</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="dt-responsive table-responsive">
                                <table id="simpletable" class="table table-striped table-bordered nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                        $cat=DB::table('blog_categories')->where('id', $data->blogcategory)->first();

                                        @endphp
                                        <tr>
                                            <td>{{$i}}</td>
                                            <td>{{$cat->blogcategory ?? Null}}</td>
                                            <td>{{$data->heading}}</td>
                                            <td>{!!Str::limit($data->sub_heading ,100, ' (...)')!!}</td>
                                            ...
                                            <td>
                                                <div class="btn-group " role="group" data-toggle="tooltip"
                                                    ...
                                                    <a href="{{route('blog_delete',$data->id)}}"
