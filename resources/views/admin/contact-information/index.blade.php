            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <a href="{{route('contactinformation_add')}}" class="btn btn-warning">Add</a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group " role="group" data-toggle="tooltip"
                                                    data-placement="top">
                                                    {{-- <a href="{{route('contactinformation_view',$data->id)}}"
                                                        class="btn btn-info btn-mini waves-effect waves-light text-white"
                                                        title="View">View</a> --}}
                                                    <a href="{{route('contactinformation_edit',$data->id)}}"
                                                        class="btn btn-warning btn-mini waves-effect waves-light text-white"
                                                        title="Edit">Edit</a>
                                                    <a href="{{route('contactinformation_delete',$data->id)}}"
