                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <form method="post" action="{{route('contactinformation_update')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <textarea id="my-editor" name="address" value="{{$data->address}}" id=""
                                            cols="100" rows="10">{{$data->address}}</textarea>
                                        <script
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="instragram_link" class="form-control" value="{{$data->instragram_link}}">
                                    </div>
                                </div>
