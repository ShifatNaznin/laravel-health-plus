            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <a href="{{route('daydeal')}}" class="btn btn-warning">Back</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="dt-responsive table-responsive">
                                <table id="simpletable" class="table table-striped table-bordered nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        $day_deals=DB::table('day_deals')->first();
                                        // dd( $day_deals);
                                        @endphp
                                        <?php
                                        if(!empty($data->image)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group " role="group" data-toggle="tooltip"
                                                    ...
                                                    <form method="post" action="{{route('daydeal_insert')}}"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="product_id" value="{{$data->id}}">
                                                        <button type="submit"
                                                            class="btn btn-danger btn-sm text-white">Add Deals Of The
                                                            Day</button>
                                                    </form>
