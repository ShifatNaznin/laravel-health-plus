            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <a href="{{route('daydeal_add')}}" class="btn btn-warning">Add</a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdown-3"
                                                    ...
                                                    <form method="post" action="{{route('daydeal_update')}}"
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdown-3"
                                                    ...
                                                    <form method="post" action="{{route('daydeal_update')}}"
                                                        ...
                                                        <input type="hidden" name="product_id" value="{{$data->product_id}}">
                                                        <button class="dropdown-item waves-light waves-effect" type="submit">
                                                            <input type="hidden" name="status" value="1"> Publish</button>
                                                        {{-- <a class="dropdown-item waves-light waves-effect" type="submit">
                                                            <input type="hidden" name="status" value="2">
                                                            Not Publish</a> --}}
                                                    </form>
                                            ...
                                            <td>
                                                <div class="btn-group " role="group" data-toggle="tooltip"
                                                    data-placement="top">
                                                    <form method="post" action="{{route('daydeal_delete')}}"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{$data->id}}">
