                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group " role="group" data-toggle="tooltip"
                                                    ...
                                                    @if (empty($featured_products->product_id))
                                                    ...
                                                    @endif
                                                    @if (isset($featured_products->product_id))

                                                    @if ($featured_products->product_id != $data->id)
                                                    <form method="post" action="{{route('featuredproducts_insert')}}"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="product_id" value="{{$data->id}}">
                                                    ...
                                                    @else
                                                    <button type="button"
                                                        class="btn btn-success btn-sm text-white">Product Already
                                                        Added</button>
                                                    @endif
                                                    @endif
