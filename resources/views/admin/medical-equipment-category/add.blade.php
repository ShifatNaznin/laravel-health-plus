            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h4>Add Medical Equipment Category</h4>
                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <a href="{{route('equipmentcategory')}}" class="btn btn-warning">Back</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="dt-responsive table-responsive">
                                <table id="simpletable" class="table table-striped table-bordered nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                        $day_deals=DB::table('medical_equipment_categories')->first();
                                        @endphp
                                        <tr>
                                            <td>{{$c}}</td>
                                            <td>{{$data->category}}</td>
                                            ...
                                            <td>
                                                <div class="btn-group " role="group" data-toggle="tooltip"
                                                    ...
                                                    <form method="post" action="{{route('equipmentcategory_insert')}}"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="category_id" value="{{$data->id}}">
                                                        <button type="submit"
                                                            class="btn btn-danger btn-sm text-white">Add Medical
