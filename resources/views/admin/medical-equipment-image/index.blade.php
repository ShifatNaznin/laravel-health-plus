            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h4>Medical Equipment Category Image List</h4>
                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <a href="{{route('equipmentcategory_image_add')}}" class="btn btn-warning">Add</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table id="simpletable" class="table table-striped table-bordered nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('/images/'.$data->image) }}" style="width: 60px;"></td>
                                            ...
                                            <td>
                                                <div class="btn-group " role="group" data-toggle="tooltip"
                                                    ...
                                                    <a href="{{route('equipmentcategory_image_edit',$data->id)}}"
                                                        class="btn btn-info btn-mini waves-effect waves-light text-white"
                                                        title="Edit"><i class="ti-pencil-alt"></i></a>
                                                    <a href="{{route('equipmentcategory_image_delete',$data->id)}}"
