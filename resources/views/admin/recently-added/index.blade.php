            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <a href="{{route('recentlyadded_add')}}" class="btn btn-warning">Add</a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdown-3"
                                                    ...
                                                    <form method="post" action="{{route('recentlyadded_update')}}"
                                            ...
                                            <td>
                                                <div class="btn-group " role="group" data-toggle="tooltip"
                                                    ...
                                                    <form method="post" action="{{route('recentlyadded_delete')}}"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{$data->id}}">
                                                        <input type="hidden" name="product_id"
