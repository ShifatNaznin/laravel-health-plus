...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="/contents/website/assets/images/favicon/favicon.png" />
    <!-- Google Fonts -->
    <link
    ...
    <link rel="stylesheet" href="/contents/website/assets/css/vendor/vendor.min.css" />
    <link rel="stylesheet" href="/contents/website/assets/css/plugins/plugins.min.css" />
    <link rel="stylesheet" href="/contents/website/assets/css/style.min.css">

    <!-- Main Style CSS -->
    <!-- <link rel="stylesheet" href="/contents/website/assets/css/style.css" />     -->
</head>
                        ...
                        <div class="col-md-6 col-lg-4 ">
                            <div class="single-wedge">
                                ...
                                <div id="mc_embed_signup" class="subscribe-form">
                                    <form class="validate" action="{{route('add_subscribe')}}" method="post"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <img class="payment-img" src="/contents/website/assets/images/icons/payment.png" alt="" />
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="/contents/website/assets/images/product-image/11.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="/contents/website/assets/images/product-image/12.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="/contents/website/assets/images/product-image/13.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="/contents/website/assets/images/product-image/14.jpg" alt="">
                                    </div>
                                </div>
                            </div>
...
============================================ -->
    ...
    <!-- Vendors JS -->
    <script src="/contents/website/assets/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="/contents/website/assets/js/vendor/bootstrap.bundle.min.js"></script>
    <script src="/contents/website/assets/js/vendor/jquery-migrate-3.3.0.min.js"></script>
    <script src="/contents/website/assets/js/vendor/modernizr-3.7.1.min.js"></script>

    <!-- Plugins JS -->
    <script src="/contents/website/assets/js/plugins/jquery-ui.min.js"></script>
    <script src="/contents/website/assets/js/plugins/swiper.min.js"></script>
    <script src="/contents/website/assets/js/plugins/countdown.js"></script>
    <script src="/contents/website/assets/js/plugins/scrollup.js"></script>
    <script src="/contents/website/assets/js/plugins/elevateZoom.js"></script>

    @stack('js')

    <!-- Main Activation JS -->
    <script src="/contents/website/assets/js/main.js"></script>
