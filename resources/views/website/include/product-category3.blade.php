        ...
        <div class="sidebar-widget padding-30px bg-light-gray-2 mb-30px">
            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="card">
                    ...
                    // $menucount=DB::table('sub_categories')->where('id',$pcat->sub_category)->count();
                    // dd($menucount);
                    @endphp
                    ...
                    <div class="card-header" id="headingOne{{$pcat->id}}">
                        <a href="#" data-toggle="collapse" data-target="#collapseOne{{$pcat->id}}"
                            aria-expanded="false" aria-controls="collapseOne{{$pcat->id}}"
                            class="collapsed">{{$pcat->category}}</a>
                    </div>

                    {{-- @endforeach --}}

                    <div id="collapseOne{{$pcat->id}}" class="collapse"
                        aria-labelledby="headingOne{{$pcat->id}}" data-parent="#accordionExample" style="">
                        <div class="card-body">
