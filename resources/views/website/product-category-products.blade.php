                    ...
                    <div class="tab-content jump">
                        ...
                        <div id="shop-1" class="tab-pane active">
                            <div class="row responsive-md-class responsive-xl-class responsive-lg-class">
                                @php
                                // dd($data->category);
                                $item=App\Models\Product::where('category',$data->id)->orderBy('id','DESC')->get();
                                @endphp
                                @foreach ($item as $datacat)
                                ...
                                <div class="col-xl-3 col-md-4 col-sm-6 ">
                                    <article class="list-product">
                                        <div class="img-block img-block2">
                                            <a href="{{route('web_product_details',$datacat->id)}}" class="thumbnail">
                                                @if(isset($v))
                                        ...
                                        <div class="product-decs">
                                            <a class="inner-link"
                                                href="{{route('web_product_details',$datacat->id)}}"><span>{{$datacat->name}}</span></a>

                                            <div class="pricing-meta">
                                                <ul>
                                                    {{-- <li class="old-price">€18.90</li> --}}
                                                    <li class="current-price">$ {{$datacat->price}}</li>
                                    ...
                                    <div class="col-md-12 padding-0px">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                                                <div class="left-img">
                                                    <div class="img-block img-block2">
                                                        <a href="{{route('web_product_details',$datacat->id)}}"
                                                            class="thumbnail">
                                                            @if(isset($v))
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                                                <div class="product-desc-wrap">
                                                    ...
                                                    <div class="box-inner">
                                                        ...
                                                        <div class="pricing-meta">
                                                            <ul>
                                                                <li class="old-price not-cut">$ {{$datacat->price}}</li>
                                                            </ul>
                                                        </div>
                                                        <div class="add-to-link">
                                                            <ul>
